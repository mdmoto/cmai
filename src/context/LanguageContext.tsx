...
const translations: Record<Language, TranslationDict> = {
  en: {
    ...
    aboutStatLocation: "Prime Hub",
    aboutStatAreaSub: "Total workspace area",
    aboutStatLocationSub: "Nong Hoi, Mahidol Rd (5 km to Airport)",
    ...
    contactAddressOfficial: "236/105 Moo 6, Mahidol Road, Nong Hoi, Mueang Chiang Mai, Chiang Mai 50000, Thailand",
    contactAddressThaiLabel: "Official Thai Registered Address:",
    contactAddressThai: "236/105 หมู่ที่ 6 ถนนมหิดล ตำบลหนองหอย อำเภอเมืองเชียงใหม่ จังหวัดเชียงใหม่ 50000",
    contactAddressNote: "Prime location along Mahidol Road, only 5 km (approx. 8 mins) from Chiang Mai International Airport (CNX).",
    footerDesc: "Chiang Mai AI Center is a premium business infrastructure platform, providing dedicated workspace, secure corporate networking, and local setup support for global tech teams.",
    footerContract: "Online Lease Agreement",
  },
  zh: {
    // Navbar
    navHome: "首页",
    ...
    aboutStatAreaSub: "独栋办公建筑总面积",
    aboutStatLocationSub: "Nong Hoi 核心区 · 玛希敦路 (距机场 5 公里)",
    ...
    contactAddressOfficial: "泰国清迈市 Mueang Chiang Mai 区 Nong Hoi 分区 Mahidol（玛希敦）路 6 组 236/105 号（邮编 50000）",
    contactAddressThaiLabel: "官方泰文法定登记地址：",
    contactAddressThai: "236/105 หมู่ที่ 6 ถนนมหิดล ตำบลหนองหอย อำเภอเมืองเชียงใหม่ จังหวัดเชียงใหม่ 50000",
    contactAddressNote: "紧邻清迈玛希敦路（Mahidol Rd）核心商务主干道，距清迈国际机场仅 5 公里（车程约 8 分钟），出差接驳极速便利。",
    footerDesc: "清迈 AI 中心（Chiang Mai AI Center）是面向出海全球团队的高端商业基础设施平台，提供专属独栋办公空间、企业级安全网络及本地合规落地一站式支持。",
    footerContract: "在线租赁合同",
  },
  th: {
    // Navbar
    navHome: "หน้าแรก",
    ...
    aboutStatAreaSub: "พื้นที่ทำงานทั้งหมด",
    aboutStatLocationSub: "ต.หนองหอย ถ.มหิดล (5 กม. จากสนามบิน)",
    ...
    contactAddressOfficial: "236/105 หมู่ที่ 6 ถนนมหิดล ตำบลหนองหอย อำเภอเมืองเชียงใหม่ จังหวัดเชียงใหม่ 50000",
    contactAddressThaiLabel: "ที่อยู่ภาษาไทยอย่างเป็นทางการ:",
    contactAddressThai: "236/105 หมู่ที่ 6 ถนนมหิดล ตำบลหนองหอย อำเภอเมืองเชียงใหม่ จังหวัดเชียงใหม่ 50000",
    contactAddressNote: "ทำเลทองติดถนนมหิดล ห่างจากสนามบินนานาชาติเชียงใหม่เพียง 5 กม. (ประมาณ 8 นาที) เดินทางสะดวกสบาย",
    footerDesc: "Chiang Mai AI Center เป็นแพลตฟอร์มโครงสร้างพื้นฐานทางธุรกิจระดับพรีเมียม ให้บริการพื้นที่ทำงาน เครือข่ายองค์กรที่ปลอดภัย และการสนับสนุนการตั้งบริษัทในท้องถิ่น",
    footerContract: "สัญญาเช่าออนไลน์",
  },
  ja: {
    // Navbar
    navHome: "ホーム",
    ...
    aboutStatAreaSub: "総ワークスペース面積",
    aboutStatLocationSub: "ノンホイ地区・マヒドン通り (空港から5km)",
    ...
    contactAddressOfficial: "タイ王国 チェンマイ県 ムアンチェンマイ郡 ノンホイ区 マヒドン通り ムー6 236/105（郵便番号 50000）",
    contactAddressThaiLabel: "タイ語公式法定登記住所：",
    contactAddressThai: "236/105 หมู่ที่ 6 ถนนมหิดล ตำบลหนองหอย อำเภอเมืองเชียงใหม่ จังหวัดเชียงใหม่ 50000",
    contactAddressNote: "マヒドン通り沿いの好立地、チェンマイ国際空港からわずか5km（車で約8分）、アクセス抜群です。",
    footerDesc: "チェンマイ AI センターは、グローバルチーム向けのプレミアムなビジネスインフラプラットフォームです。専用オフィス、企業向けセキュアネットワーク、現地法人設立までワンストップでサポートします。",
    footerContract: "オンライン賃貸契約",
  },
};
