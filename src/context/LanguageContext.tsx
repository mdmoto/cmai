...
const translations: Record<Language, TranslationDict> = {
  en: {
    ...
    heroSubtitle: "Connecting China-Thailand intelligence, empowering Chinese smart manufacturing to expand globally with green computing and cutting-edge AI.",
    ...
    aboutDesc: "Co-founded by veteran IT leaders from China and Thailand alongside global digital nomad pioneers, Chiang Mai AI Center is headquartered in Chiang Mai, Thailand — Southeast Asia's most innovative international digital hub.",
    aboutLead: "Co-founded by veteran IT leaders from China and Thailand alongside global digital nomad pioneers, Chiang Mai AI Center is headquartered in Chiang Mai, Thailand — Southeast Asia's most innovative international digital hub.",
    aboutSynergyTitle: "AI Applications · High-Performance Computing · Clean Green Energy",
    aboutSynergySub: "Focusing on the deep synergy of our core triad to build a transnational innovation ecosystem across the entire AI value chain:",
    aboutPillar1Title: "AI Venture Incubation & Acceleration",
    aboutPillar1Desc: "Providing cross-border teams with scenario testing, localization strategies, and global capital connectivity.",
    aboutPillar2Title: "Token & AI Model Globalization",
    aboutPillar2Desc: "Establishing compliant pathways to bring top foundation models and AI applications to Southeast Asia and global markets.",
    aboutPillar3Title: "High-Performance Green Computing",
    aboutPillar3Desc: "Deploying resilient GPU clusters to provide reliable power for high-throughput inference and commercial simulations.",
    aboutPillar4Title: "Renewable Energy & Storage Matchmaking",
    aboutPillar4Desc: "Leveraging regional solar and wind energy to realize sustainable infrastructure powering large-scale computing with clean energy.",
    aboutMissionTitle: "Our Mission",
    aboutMissionDesc: "Leveraging Chiang Mai's strategic advantages and full-stack ecosystem to serve as a 'Super Connector' for Chinese manufacturing and enterprise brands going global, enabling seamless integration into the new era of global economic prosperity.",
    ...
    featureAC: "Dedicated A/C",
    featureWindow: "Window",
    featureNoAC: "Shared A/C",
    featureNoWindow: "No Window",
    workspaceDesks: "Desks",
    ...
    pricingOfficeSizeS: "Small Office (1-2 Pax)",
    pricingOfficeSizeM: "Medium Office (3-4 Pax)",
    pricingOfficeSizeL: "Large Office (5-6 Pax)",
  ...
  zh: {
    ...
    // Hero
    heroTitle: "清迈 AI 中心",
    heroSubtitle: "链接中泰智慧，以绿色算力与前沿 AI 赋能中国智造出海全球",
    ...
    aboutSub: "商业基础设施平台",
    aboutDesc: "清迈 AI 中心（Chiang Mai AI Center）由中泰两国资深 IT 领军团队与全球顶尖数字游民精英联合创立，坐落于东南亚极具创新活力的国际数字枢纽——泰国清迈。",
    aboutLead: "清迈 AI 中心（Chiang Mai AI Center）由中泰两国资深 IT 领军团队与全球顶尖数字游民精英联合创立，坐落于东南亚极具创新活力的国际数字枢纽——泰国清迈。",
    aboutSynergyTitle: "AI 算法应用 · 高性能算力 · 绿色清洁能源",
    aboutSynergySub: "我们聚焦于「AI 算法应用 · 高性能算力 · 绿色清洁能源」三位一体的产业深度协同，构建了贯穿 AI 全产业链的跨国创新闭环：",
    aboutPillar1Title: "AI 创投孵化与生态加速",
    aboutPillar1Desc: "为出海团队提供场景测试、本地化战略与全球资本对接。",
    aboutPillar2Title: "中国 Token 与 AI 模型出海",
    aboutPillar2Desc: "搭建合规通道，推动中国顶尖大模型与 AI 应用走向东南亚及全球市场。",
    aboutPillar3Title: "高性能绿色算力租赁",
    aboutPillar3Desc: "部署高可用 GPU 算力集群，为高负载推理与商业演练提供澎湃动力。",
    aboutPillar4Title: "风光储新能源撮合",
    aboutPillar4Desc: "依托东南亚丰富光伏与风能资源，实现“以清洁能源驱动大算力”的可持续基础设施。",
    aboutMissionTitle: "我们的使命",
    aboutMissionDesc: "依托清迈独特的地缘优势与全栈软硬件生态，作为中国制造业与实体品牌走向全球的“超级连接器”，助推中国智造无缝融入全球经济新繁荣。",
    aboutStatArea: "总面积",
    ...
    pricingOfficeSizeS: "小型办公室 (1-2 人)",
    pricingOfficeSizeM: "中型办公室 (3-4 人)",
    pricingOfficeSizeL: "大型办公室 (5-6 人)",
  ...
  th: {
    ...
    // Hero
    heroTitle: "Chiang Mai AI Center",
    heroSubtitle: "เชื่อมโยงภูมิปัญญาไทย-จีน เสริมศักยภาพการผลิตอัจฉริยะของจีนสู่ระดับโลกด้วยพลังการประมวลผลสีเขียวและ AI ล้ำสมัย",
    ...
    aboutDesc: "Chiang Mai AI Center ก่อตั้งขึ้นร่วมกันโดยผู้นำด้าน IT จากจีนและไทย พร้อมด้วยผู้บุกเบิกดิจิทัลโนแมดระดับโลก ตั้งอยู่ในศูนย์กลางดิจิทัลระดับนานาชาติที่เปี่ยมด้วยนวัตกรรมแห่งเอเชียตะวันออกเฉียงใต้ — เชียงใหม่ ประเทศไทย",
    aboutLead: "Chiang Mai AI Center ก่อตั้งขึ้นร่วมกันโดยผู้นำด้าน IT จากจีนและไทย พร้อมด้วยผู้บุกเบิกดิจิทัลโนแมดระดับโลก ตั้งอยู่ในศูนย์กลางดิจิทัลระดับนานาชาติที่เปี่ยมด้วยนวัตกรรมแห่งเอเชียตะวันออกเฉียงใต้ — เชียงใหม่ ประเทศไทย",
    aboutSynergyTitle: "แอปพลิเคชัน AI · การประมวลผลประสิทธิภาพสูง · พลังงานสะอาดสีเขียว",
    aboutSynergySub: "เรามุ่งเน้นการทำงานร่วมกันอย่างลึกซึ้งแบบบูรณาการ 3 มิติ เพื่อสร้างวงจรนวัตกรรมข้ามชาติที่ครอบคลุมตลอดห่วงโซ่อุตสาหกรรม AI:",
    aboutPillar1Title: "การบ่มเพาะและการเร่งการเติบโตของ AI",
    aboutPillar1Desc: "จัดเตรียมการทดสอบสถานการณ์จริง กลยุทธ์การปรับตัวสู่ท้องถิ่น และการเชื่อมต่อกับแหล่งทุนระดับโลก",
    aboutPillar2Title: "การขยายตัวของ Token และ AI โมเดลสู่สากล",
    aboutPillar2Desc: "สร้างช่องทางที่ถูกต้องตามกฎระเบียบเพื่อผลักดันโมเดล AI และแอปพลิเคชันชั้นนำสู่ตลาดโลก",
    aboutPillar3Title: "บริการเช่าพลังการประมวลผลสีเขียวสมรรถนะสูง",
    aboutPillar3Desc: "ติดตั้งคลัสเตอร์ GPU ความพร้อมใช้งานสูง เพื่อขับเคลื่อนการอนุมานและการจำลองเชิงพาณิชย์",
    aboutPillar4Title: "การจับคู่พลังงานหมุนเวียนแสงอาทิตย์และลม",
    aboutPillar4Desc: "ใช้ประโยชน์จากพลังงานแสงอาทิตย์และพลังงานลมที่อุดมสมบูรณ์ ขับเคลื่อนโครงสร้างพื้นฐานการประมวลผลขนาดใหญ่ด้วยพลังงานสะอาด",
    aboutMissionTitle: "พันธกิจของเรา",
    aboutMissionDesc: "ด้วยข้อได้เปรียบทางภูมิศาสตร์และระบบนิเวศแบบฟูลสแตกของเชียงใหม่ เราทำหน้าที่เป็น 'Super Connector' เพื่อนำภาคการผลิตและแบรนด์ก้าวสู่เวทีระดับโลกอย่างราบรื่น",
    ...
    workspaceUnit: "ห้อง/ยูนิต",
    workspaceType: "ประเภท",
    workspaceFeatures: "คุณลักษณะ",
    featureAC: "แอร์ส่วนตัว",
    featureWindow: "หน้าต่าง",
    featureNoAC: "แอร์ส่วนกลาง",
    featureNoWindow: "ไม่มีหน้าต่าง",
    workspaceDesks: "โต๊ะทำงาน",
    ...
    pricingOfficeSizeS: "ออฟฟิศขนาดเล็ก (1-2 คน)",
    pricingOfficeSizeM: "ออฟฟิศขนาดกลาง (3-4 คน)",
    pricingOfficeSizeL: "ออฟฟิศขนาดใหญ่ (5-6 คน)",
  ...
  ja: {
    ...
    heroSubtitle: "中泰の知見を融合し、グリーン演算力と最先端AIで中国のスマート製造の世界展開を加速。",
    ...
    aboutDesc: "中泰両国のベテランITリーダーと世界トップクラスのデジタルノマド精鋭によって共同設立されたChiang Mai AI Centerは、東南アジア随一のイノベーションハブであるタイ・チェンマイに位置しています。",
    aboutLead: "中泰両国のベテランITリーダーと世界トップクラスのデジタルノマド精鋭によって共同設立されたChiang Mai AI Centerは、東南アジア随一のイノベーションハブであるタイ・チェンマイに位置しています。",
    aboutSynergyTitle: "AIアルゴリズム応用 · 高性能演算力 · グリーンクリーンエネルギー",
    aboutSynergySub: "三位一体の産業深度シナジーに注力し、AI全産業チェーンを貫く国境を越えたイノベーション循環を構築:",
    aboutPillar1Title: "AI創投インキュベーション＆アクセラレーション",
    aboutPillar1Desc: "海外進出チームに実証実験、現地化戦略、および世界規模の資本調達アクセスを提供。",
    aboutPillar2Title: "Token・AIモデルのグローバル展開",
    aboutPillar2Desc: "コンプライアンス準拠のパイプラインを構築し、最先端の大規模モデルとAI応用を世界市場へ展開。",
    aboutPillar3Title: "高性能グリーン演算力レンタル",
    aboutPillar3Desc: "高可用性GPUクラスターを配備し、高負荷推論やビジネスシミュレーションに圧倒的な計算能力を提供。",
    aboutPillar4Title: "再エネ（太陽光・風力・蓄電）マッチング",
    aboutPillar4Desc: "東南アジアの豊かな太陽光・風力資源を活用し、「クリーンエネルギーで駆動する大演算力」の持続可能インフラを実現。",
    aboutMissionTitle: "私たちの使命",
    aboutMissionDesc: "チェンマイ独自の地政学的優位性とフルスタックのハード・ソフト生態系を活かし、製造業および実体ブランドが海外展開するための「スーパーコネクター」として、新時代の世界経済繁栄へのシームレスな統合を促進します。",
    aboutStatArea: "総面積",
    ...
    workspaceUnit: "ユニット",
    workspaceType: "タイプ",
    workspaceFeatures: "特徴/設備",
    featureAC: "個別空調",
    featureWindow: "窓あり",
    featureNoAC: "共同空調",
    featureNoWindow: "窓なし",
    workspaceDesks: "標準デスク",
    ...
    pricingOfficeSizeS: "小規模オフィス (1-2名)",
    pricingOfficeSizeM: "中規模オフィス (3-4名)",
    pricingOfficeSizeL: "大規模オフィス (5-6名)",
